 ...
 *  see <code><a href="http://www.docjar.com/html/api/java/util/Scanner.java.html">
 *  Scanner.java</a></code> (NB: Java 6u23 and earlier uses only \r, \r, \r\n).
 */
public final class In {
	 ...
	 * <code>new Scanner(String)</code> to read from a string.
	 * <p>
	 ...
	 * <code>new In(filename)</code>.{@link #readAllInts()}
	 */
	 ...
	 * @deprecated Clearer to use
	 * <code>new In(filename)</code>.{@link #readAllDoubles()}
	 */
	 ...
	 * @deprecated Clearer to use
	 * <code>new In(filename)</code>.{@link #readAllStrings()}
	 */
